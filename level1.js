var level1 = {
	preload: function()
	{
		...
		this.load.tilemap('level', 'assets/LaVL1.json', null,
	...
	create: function()
	{
		...
		game.stage.backgroundColor = '#0d3311';
		...
		map.setCollisionBetween(3, 12, true, 'nextlvl');
		nextlvl = map.createLayer('nextlvl');
		nextlvl.resizeWorld();
		...
		scoretest = game.add.text(20, 20, 'Score: 0', { fontSize: '20px', fill: '#0019ff' });
	...
	update: function() 
	{
		game.physics.arcade.collide(player,nextlvl,nextoflvlOverlap);
